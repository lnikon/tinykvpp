...
template <typename T, std::endian Target = std::endian::little>
class endian_integer {
 public:
  ...
  [[nodiscard]] auto bytes() const noexcept -> std::span<const std::byte> { return m_bytes; }

...
public:
  TinyKVPPServiceImpl(db::db_t &db) : m_db(db) {}

  grpc::Status Put(grpc::ServerContext *pContext, const PutRequest *pRequest,
  ...
  grpc::Status Get(grpc::ServerContext *pContext, const GetRequest *pRequest,

...
segment_shared_ptr_t lsmtree_segment_manager_t::get_segment(
    const std::string &name)
{
    return m_pStorage->segment(name);
}

lsmtree::segments::storage::shared_ptr_t
lsmtree_segment_manager_t::get_segments()
{
...
std::filesystem::path lsmtree_segment_manager_t::construct_path(

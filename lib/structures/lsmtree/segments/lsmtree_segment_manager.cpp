...
lsmtree_segment_manager_t::lsmtree_segment_manager_t(const config::shared_ptr_t &config,
...
segment_shared_ptr_t lsmtree_segment_manager_t::get_new_segment(const structures::lsmtree::lsmtree_segment_type_t type,
...
segment_shared_ptr_t lsmtree_segment_manager_t::get_segment(const std::string &name)
{
    return m_pStorage->segment(name);
}

lsmtree::segments::storage::shared_ptr_t lsmtree_segment_manager_t::get_segments()
{
    return m_pStorage->shared_from_this();
}

std::vector<lsmtree_segment_manager_t::segment_name_t> lsmtree_segment_manager_t::get_segment_names() const
{
...
std::vector<std::filesystem::path> lsmtree_segment_manager_t::get_segment_paths() const
{
...
std::filesystem::path lsmtree_segment_manager_t::construct_path(const std::string &name) const
{
    return m_config->datadir_path() / name;
}
